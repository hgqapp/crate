...
class VarCharType extends PGType<Object> {
    ...
    public int writeAsBinary(ByteBuf buffer, @Nonnull Object value) {
        byte[] bytes = DataTypes.STRING.sanitizeValue(value).getBytes(StandardCharsets.UTF_8);
    ...
    protected byte[] encodeAsUTF8Text(@Nonnull Object value) {
        return DataTypes.STRING.sanitizeValue(value).getBytes(StandardCharsets.UTF_8);
    }
